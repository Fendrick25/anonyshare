...
public class UserAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7694723934235674352L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAvroModel\",\"namespace\":\"com.anonyshare.kafka.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"username\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"imageUrl\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public UserAvroModel(java.lang.String id, java.lang.String username, java.lang.String imageUrl) {
    this.id = id;
   ...
   */
  public static com.anonyshare.kafka.model.UserAvroModel.Builder newBuilder() {
    return new com.anonyshare.kafka.model.UserAvroModel.Builder();
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.anonyshare.kafka.model.UserAvroModel.Builder newBuilder(com.anonyshare.kafka.model.UserAvroModel.Builder other) {
    if (other == null) {
      return new com.anonyshare.kafka.model.UserAvroModel.Builder();
    } else {
      return new com.anonyshare.kafka.model.UserAvroModel.Builder(other);
    }
  }
   ...
   * @return A new UserAvroModel RecordBuilder
   */
  public static com.anonyshare.kafka.model.UserAvroModel.Builder newBuilder(com.anonyshare.kafka.model.UserAvroModel other) {
    if (other == null) {
      return new com.anonyshare.kafka.model.UserAvroModel.Builder();
    } else {
      return new com.anonyshare.kafka.model.UserAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.anonyshare.kafka.model.UserAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.anonyshare.kafka.model.UserAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder setImageUrl(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.anonyshare.kafka.model.UserAvroModel.Builder clearImageUrl() {
      imageUrl = null;
